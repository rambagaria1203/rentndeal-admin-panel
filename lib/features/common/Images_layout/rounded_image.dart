...
class RoundedImage extends StatelessWidget {
  ...
  Widget _buildNetworkImage() {
    if (image != null) {
      // Use CacheNetworkImage for efficient loading and caching of network image
      return CachedNetworkImage(
        fit: fit,
        color: overlayColor,
        imageUrl: image!,
        errorWidget: (context, url, error) => const Icon(Icons.error),
        progressIndicatorBuilder: (context, url, downloadProgress) => ShimmerEffect(width: width, height: height),
      );
    } else {
  ...
  // Function to build the assest image widget
